...
from agent.show_object_location.show_object_location import ShowObjectLocation
...
workflow = ConductorWorkflow(name='find_object_workflow_quick_zh')
...
# 3. If object exists, show its location from stm
task3 = simple_task(task_def_name='ShowObjectLocation', task_reference_name='show_object_location')
